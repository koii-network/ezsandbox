...
While writing your own audit might seem difficult, you can think of it as a combination of basic operations, similar to BEDMAS. 
<!-- Comment - Define BEDMAS (Order of operations in math)-->
